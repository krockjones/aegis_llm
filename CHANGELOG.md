...
- **License:** the project is released under the **Apache License 2.0** ([LICENSE](LICENSE)); [README.md](README.md) and [pyproject.toml](pyproject.toml) updated from proprietary wording. Copyright notice: **AegisOneConnect, LLC** (see LICENSE appendix).
