...
**Live checks** (real Ollama and optionally a running Guard process) use `AEGISLLM_LIVE_OLLAMA=1`. See `build_log/TESTING_NOTES.md` for `AEGISLLM_GUARD_BASE_URL` and upstream URL variables.
